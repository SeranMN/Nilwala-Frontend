...
const Home = () => {
  ...
  const iframe2 = '<iframe style="width:95vw;height:90vh" src="https:anyflip.com/bookcase/mcenl/"  seamless="seamless" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" ></iframe>'
