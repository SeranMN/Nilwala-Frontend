...
const HomeCards = () => {
  ...
  return (
    <Card sx={{ backgroundColor: 'black', mt: '30px' }}>
      <Typography variant="h2" color='#00a2e2' mt={4} >
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={5} md={4} lg={8} padding={2} data-aos="fadeInAnimation" data-aos-duration="1000">
          <Typography variant="h6" sx={{ textAlign: 'justify', mt: '35px', fontStyle: 'italic' }} color='#00a2e2' paragraph>
